...
namespace io.harness.ff_dotnet_client_sdk.openapi.Model
{
    ...
    internal partial class AuthenticationResponse : IEquatable<AuthenticationResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public AuthenticationResponse(string authToken = default(string))
        {
            // to ensure "authToken" is required (not null)
            if (authToken == null)
            {
                throw new ArgumentNullException("authToken is a required property for AuthenticationResponse and cannot be null");
            }
